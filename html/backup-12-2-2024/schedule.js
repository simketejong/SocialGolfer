...
// You must trigger this function from a user action (e.g., a button click) due to security reasons
...
//                [["O","B","K","L"],["H","D","Q","M"],["N","I","A","S"],["R","T","E","G"],["C","F","P","J"]]]
    schedule = [[['H', 'V', 'Y', 'X'], ['S', 'D', 'E', 'B'], ['U', 'P', 'J', 'A'], ['I', 'T', 'L', 'Z'], ['K', 'O', 'G', 'N'], ['F', 'R', 'C'], ['Q', 'M', 'W']], [['L', 'G', 'X', 'B'], ['F', 'J', 'V', 'Z'], ['I', 'Q', 'O', 'A'], ['T', 'M', 'P', 'Y'], ['U', 'R', 'E', 'N'], ['D', 'K', 'W'], ['S', 'H', 'C']], [['H', 'R', 'W', 'B'], ['Q', 'P', 'C', 'X'], ['M', 'V', 'G', 'E'], ['S', 'J', 'L', 'K'], ['U', 'O', 'Y', 'Z'], ['T', 'D', 'A'], ['I', 'F', 'N']], [['M', 'Z', 'N'], ['T', 'X', 'W'], ['H', 'J', 'G'], ['F', 'L', 'E'], ['K', 'C', 'A'], ['U', 'Q', 'B'], ['S', 'P', 'O', 'V'], ['I', 'R', 'D', 'Y']], [['I', 'M', 'K', 'X'], ['S', 'Y', 'G', 'A'], ['Q', 'H', 'Z', 'E'], ['L', 'C', 'N', 'W'], ['T', 'R', 'J', 'O'], ['U', 'D', 'V'], ['F', 'P', 'B']]]
